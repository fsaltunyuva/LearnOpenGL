...
#pragma endregion
    ...
    Shader lightingShader("shaders/basic_lighting_exercise4.vs", "shaders/basic_lighting_exercise4.fs");
...
#pragma endregion
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // exercise 1
        glm::vec3 sinMovement = glm::vec3(sin(glfwGetTime()), lightPos.y, lightPos.z);
        lightPos = sinMovement;
