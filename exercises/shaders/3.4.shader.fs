...
//   FragColor = mix(texture(texture1, TexCoord), texture(texture2, -TexCoord), 0.2); // exercise 1
   FragColor = mix(texture(texture1, TexCoord), texture(texture2, -TexCoord), blendAmount); // exercise 1
}