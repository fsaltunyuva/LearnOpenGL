...
> [!IMPORTANT]
> Do not forget to set the working directory to ```$ProjectFileDir$```. In CLion, Run/Edit Configurations, then set Working Directory as ```$ProjectFileDir$```. Otherwise, ```shaders/3.3.shader.vs``` will not work.
